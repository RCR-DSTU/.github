...
| ![Robocross](https://github.com/Casonka/Robocross) | Проект беспилотного автомобиля, наработки по которому были использованы при подготовке к открытым испытаниям беспилотных ТС РОБОКРОСС 2022 |
| ![EduBot](https://github.com/RCR-DSTU/EduBot) | Проект для обучения резидентов центра основам робототехники. К проекту прилагается проект для обучения, а также платформа с дифференциальной кинематикой |
...
Наш почтовый адрес - rcr-dstu@yandex.ru
